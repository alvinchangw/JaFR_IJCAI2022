...
import data
import models
from utils import rob_acc, rob_acc_autoattack
import glob
...
def get_args():
    ...
    parser.add_argument('--do_autoattack', action='store_true', help='eval autoattack instead of pgd')
...
if args.do_autoattack:
    print('do autoattack, eps: ', eps)
    acc_pgd_rr, loss_pgd_rr = rob_acc_autoattack(eval_batches, model, eps, pgd_alpha_rr, opt, half_prec, pgd_rr_n_iter, pgd_rr_n_restarts, print_fosc=False, pgd_loss_func=args.pgd_loss_func)
else:
