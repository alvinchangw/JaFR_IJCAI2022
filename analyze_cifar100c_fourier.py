...
def get_args():
    ...
    parser.add_argument('--dataset', default='cifar100', choices=['mnist', 'svhn', 'cifar10', 'cifar10_binary', 'uniform_noise'], type=str)
    parser.add_argument('--set', default='test', type=str, choices=['train', 'test'])

    parser.add_argument('--analysis_dir', default='analysis/c100_corruption',
